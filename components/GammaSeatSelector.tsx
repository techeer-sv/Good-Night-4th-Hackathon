  ...
  return (
    <div className={inter.className + ' gamma-seat-wrap mx-auto'} style={{maxWidth: '1100px'}}>
      ...
      <style jsx>{`
        :root {
          --gamma-bg: #f7f7fb;
          --gamma-card-bg: #ffffff;
          --gamma-text: #111827;
          --gamma-muted: #6b7280;
          --gamma-line: #e5e7eb;
          --gamma-accent-500: #7c3aed;
          --gamma-accent-400: #8b5cf6;
          --gamma-accent-300: #a78bfa;
          --gamma-accent-grad: linear-gradient(135deg, var(--gamma-accent-500) 0%, var(--gamma-accent-300) 100%);
          --gamma-shadow-lg: 0 20px 40px rgba(17,24,39,0.10);
          --gamma-shadow-md: 0 10px 24px rgba(17,24,39,0.08);
          --gamma-seat-size: 36px;
          --gamma-gap: 8px;
          --gamma-seat-std: #e9ecf5;
          --gamma-seat-premium: #e7e7ff;
          --gamma-seat-aisle: #eaf8ff;
          --gamma-seat-wheel: #e7ffe7;
          --gamma-seat-sold: #f3f4f6;
          --gamma-seat-ring: rgba(124,58,237,0.22);
        }
