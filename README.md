...
#### 1. 좌석 선택
- STAGE 화면에서 원하는 좌석을 클릭하여 선택
- 선택된 좌석은 초록색으로 표시
- 여러 좌석을 동시에 선택 가능

#### 2. 예매 진행
- 좌석 선택 후 하단의 "예매하기" 버튼 클릭
- 예약자 정보 입력 페이지로 이동
...
#### 4. 예매 결과
- 예매 성공시 예매 성공 팝업 뜬 후 좌석 선택 페이지 이동
- 예매 실패시 예매 실패 팝업 뜬 후 예약자 정보 입력 페이지 초기화
...
- [x] 타입 체크
    ...
    - 도메인별 유효성 체크(좌석 번호, 좌석 배열, 페이지 상태, 로딩 상태태)
